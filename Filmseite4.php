...
<html lang = "de">
    <head>
        <title> Der Aufstieg Skywalkers </title> 
        <meta charset = "UTF-8">
...
>>>>>>> 2aad306082da6f488c0b3610dc8b57593bd6f0f7
    ...
    <?php
        ...
        <main>
            <article>
               <h1> Der Aufstieg Skywalkers</h1>
    <!-- Film Video -->
               <div class="VideoBox">
                <iframe width="100" height="100" src="https://www.youtube.com/embed/dlb0aUZKQpk?autoplay=1&mute=1&controls=0&loop=1&fs=0&modestbranding=1&playlist=dlb0aUZKQpk&rel=0"  allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture; fullscreen"  style="border:0;position: absolute; top: 0px; left: 0px; width: 100%; height: 100%;"></iframe>
               </div>                       
               ...
               <div class="FilmBox">
                    ...
                    <div style="width: 590px;" class="FilmBoxElement">
                        <ul style="list-style: none;">
                            <li> <h1> Starwars: Der Aufstieg Skywalkers</h1> <br> </li>
