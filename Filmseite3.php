...
<html lang = "de">
    ...
    <!-- Film Video -->
               <div class="VideoBox">
                <iframe width="100" height="100" src="https://www.youtube.com/embed/4PCNfzjIzaI?autoplay=1&mute=1&controls=0&loop=1&fs=0&modestbranding=1&playlist=4PCNfzjIzaI&rel=0&start=3"  allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture; fullscreen"  style="border:0;position: absolute; top: 0px; left: 0px; width: 100%; height: 100%;"></iframe>
               </div>                       
    ...
    <!-- Film Details-->
                <div class="FilmBox" >
                    <div class="TextDetail">
                        <h4> Film-Details </h4>
                        <br>
                        <p class="p2"> Der Science-Fiction-Action-Spionage-Film ist der elfte Film des britisch-US-amerikanischen Regisseurs Christopher Nolan.  </p> 
                        <br>
                        <table class="TDetail">
                            <colgroup>
                            ...
                            <tr> 
                                ...
                                <td><p class="p1">  Christopher Nolan </p></td>
                            </tr>
                            <tr> 
                                <td><p class="p1"> <span style="font-weight: bold;">Musik:</span> </p></td>
                                <td><p class="p1">  Ludwig Göransson </p></td>
                            </tr>
                            <tr> 
                            ...
                            <tr> 
                                ...
                                <td><p class="p1">  Jennifer Lame </p></td>
                            </tr>
                        </table>
                    </div>
                                    
                    <div class="BildDetail">
                        <img src="Medien/Bilder/Tenet3.jpg" class="DBild" alt="Tenet" title="Tenet">
                        <!-- https://www.lascimmiapensa.com/wp-content/uploads/2020/08/tenet-trailer-finale.jpg-->
                    </div>
                </div>
    <!-- Ticket Box-->
                <div class="TicketBox" >
