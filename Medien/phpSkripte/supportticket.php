...
<form id = "form" action = "Action.php" method = "post"> <!-- Bei method Post sieht man anders als bei "GET" die Parameter nicht in der URL -->
    ...
    <p class = "special">
        <!-- Hier könnte man noch ein Limit an Wörtern festsetzen / Leider hat es zeitlich nicht mehr geklappt -->
    ...
    <div id = "message-container"> <!-- Hier kommt die Fehlermeldung rein falls man zum Beispiel ein Feld leer gelassen hat --> 
