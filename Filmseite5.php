...
<html lang = "de">
    ...
    <!-- Film Video -->
               <div class="VideoBox">
                <iframe width="100" height="100" src="https://www.youtube.com/embed/DKTJ47b-ULM?autoplay=1&mute=1&controls=0&loop=1&fs=0&modestbranding=1&playlist=DKTJ47b-ULM&rel=0&start=2"  allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture; fullscreen"  style="border:0;position: absolute; top: 0px; left: 0px; width: 100%; height: 100%;"></iframe>
               </div>                                 
                    ...
                    <div class="TextDetail">
                        ...
                        <table class="TDetail">
                            ...
                            <tr> 
                                ...
                                <td><p class="p1"> Tim Miller </p></td>
                            </tr>
                            <tr> 
                                <td><p class="p1"> <span style="font-weight: bold;">Kamera:</span> </p></td>
                                <td><p class="p1">  Ken Seng </p></td>
                            </tr>
                            <tr> 
                                <td><p class="p1"> <span style="font-weight: bold;">Drehbuch:</span> </p> </td>
                                <td><p class="p1">  Rhett Reese, Rob Liefeld, Paul Wernick </p></td>
                            </tr>
                            <tr> 
                                <td> <p class="p1"> <span style="font-weight: bold;">Produzent:</span> </p></td>
                                <td><p class="p1"> Lauren Shuler-Donner, Simon Kinberg </p></td>
                            </tr>
                        </table>
                    </div>
