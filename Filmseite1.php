...
<html lang = "de">
    ...
    <!-- Film Video -->
                <div class="VideoBox">
                <iframe width="100" height="100" src="https://www.youtube.com/embed/ITIqAwr9bUo?autoplay=1&mute=1&controls=0&disablekb=1&loop=1&playlist=ITIqAwr9bUo&modestbranding=1"  allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture; fullscreen"  style="border:0;position: absolute; top: 0px; left: 0px; width: 100%; height: 100%;"></iframe>
                </div>
    ...
    <!-- Film Details-->
                <div class="FilmBox" >
                    <div class="TextDetail">
                        <h4> Film-Details </h4>
                        <br>
                        <p class="p2"> Daniel Craig spielt im 25. Bond-Film erneut den britischen Geheimagenten, der diesmal unter der Regie des „True Detective“-Machers gegen Terroristen kämpft. </p> 
                        <br>
                        <table class="TDetail">
                            <colgroup>
                            ...
                            <tr>  
                                ...
                                <td><p class="p1">  Cary Joji Fukunaga </p></td>
                            </tr>
                            <tr> 
                                <td><p class="p1"> <span style="font-weight: bold;">Produzent:</span> </p></td>
                                <td><p class="p1">  Michael G. Wilson, Barbara Broccoli </p></td>
                            </tr>
                            <tr> 
                                <td><p class="p1"> <span style="font-weight: bold;">Drehbuch:</span> </p> </td>
                                <td><p class="p1">  Neal Purvis, Robert Wade </p></td>
                            </tr>
                            <tr> 
                                <td> <p class="p1"> <span style="font-weight: bold;">Produktionsland:</span> </p></td>
                                <td><p class="p1">  Großbritannien, USA </p></td>
                            </tr>
                        </table>
                    </div>
